...
<div class="user-infos">
    ...
    <h1 class="text-white text-center mb-3 name-user">{{ $user->name }}</h1>
    <h3 class="text-white text-center mb-3 level-user">-</h3>
    <h3 class="text-white text-center mb-3 level-user">Level {{ $user->level }}</h3>
